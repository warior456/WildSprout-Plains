package net.ugi.wildsprout_plains.config;
...
import static net.ugi.wildsprout_plains.WildSproutPlains.CONFIG;

public class Config {

    private static final Gson GSON = new GsonBuilder().setPrettyPrinting().create();
    private static final File CONFIG_FILE = new File(FabricLoader.getInstance().getConfigDir().toFile(), WildSproutPlains.MOD_ID + "_config.json");
    public static void loadConfig() {
        if (CONFIG_FILE.exists()) {
            try (BufferedReader reader = new BufferedReader(new FileReader(CONFIG_FILE))) {
                ...
                WildSproutPlains.LOGGER.warn("The config could not be loaded: " + e.getLocalizedMessage());
        ...
        try (FileWriter writer = new FileWriter(CONFIG_FILE)) {
            ...
            while (iterator.hasNext()) {
                ...
                try {
                    ...
                    WildSproutPlains.LOGGER.warn("Could not access config field: " + field.getName());
                }
            ...
            WildSproutPlains.LOGGER.warn("The config could not be saved: " + e.getLocalizedMessage());
        }
    }
}
